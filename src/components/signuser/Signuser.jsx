      ...
      <div>
        <div class="min-h-screen flex flex-col items-center justify-center mb-8">
          <div class="box-login flex flex-col bg-white px-4 sm:px-6 md:px-8 lg:px-10 py-8 rounded-md w-full max-w-md">
            <div class="font-medium text-center flex justify-center items-center self-center pb-4 w-full text-gray-800 border-b-gray-300 border-b-2">
              <AiOutlineClose class="w-4 h-4 flex-1" />
              <div>Inicia sesión o regístrate</div>
